  ...
  return (
    <div className="container">
      ...
      <Slider {...settings}>
        <div className="">
          <img
            className="lg:w-[100%] md:w-[100%] sm:w-[100%] w-[100%]"
            src={src1}
          />
        </div>
        <div>
            ...
            <div className="bg-white w-[300px] lg:w-[100%] md:w-[300px] sm:w-[300px]">
              ...
              <div>
                <div>
                  ...
                  <p className="text-sm pt-1 pl-2">
                    <strong>Foodieland.</strong> Sweet food can bring someon
                    into happiness as long as they don’t eat to much
                  </p>
                  <p className="text-sm text-gray-400 pt-4 pl-2 pb-3">
                    <i>September 19</i>
                  </p>
            ...
            <div className="bg-white w-[300px] lg:w-[100%] md:w-[300px] sm:w-[300px]">
              ...
              <div>
                <div>
                  ...
                  <p className="text-sm pt-1 pl-2">
                    <strong>Foodieland.</strong> Steak never be wrong, it’s
                    suitable for you who want romantic dinner
                  </p>
                  <p className="text-sm text-gray-400 pt-4 pl-2 pb-3">
                    <i>September 19</i>
                  </p>
